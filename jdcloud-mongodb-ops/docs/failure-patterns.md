# Failure Patterns — jdcloud-mongodb-ops
...
- **Command**: `jdc mongodb describe-instance --instance-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (mongodb-xxxxxxxx)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-mongodb-ops
- **Command**: `jdc mongodb describe-instances` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-mongodb-ops
- **Command**: `jdc mongodb describe-instances --output json` (wrong position)
...
- **Skill**: jdcloud-mongodb-ops
- **Command**: `jdc mongodb delete-instance --instance-id <id>` (when instance is in use)
- **Error**: `ResourceInUse`
...
- **Category**: skill_generation
- **Skill**: jdcloud-mongodb-ops
- **Command**: `jdc mongodb create-instance`
...
- **Skill**: jdcloud-mongodb-ops
- **Command**: `jdc mongodb describe-instances --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-mongodb-ops` |
