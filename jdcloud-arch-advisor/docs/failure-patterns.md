# Failure Patterns — jdcloud-arch-advisor
...
> **Note**: `jdcloud-arch-advisor` is a meta skill — it performs architecture
> assessments and recommendations rather than direct resource CRUD. Command
> examples below reflect assessment workflows and downstream delegation calls.
...
- **Command**: `jdc arch describe-assessment --assessment-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (assessment UUID)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-arch-advisor
- **Command**: `jdc arch describe-assessments` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-arch-advisor
- **Command**: `jdc arch describe-assessments --output json` (wrong position)
...
- **Skill**: jdcloud-arch-advisor
- **Command**: `jdc arch delete-assessment --assessment-id <id>` (when assessment is in use)
- **Error**: `ResourceInUse`
...
- **Category**: skill_generation
- **Skill**: jdcloud-arch-advisor
- **Command**: `jdc arch create-assessment`
...
- **Skill**: jdcloud-arch-advisor
- **Command**: `jdc arch describe-assessments --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-arch-advisor` |
