# Failure Patterns — jdcloud-iam-ops
...
- **Command**: `jdc iam describe-user --user-name <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (user name must match allowed pattern)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-iam-ops
- **Command**: `jdc iam describe-users` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-iam-ops
- **Command**: `jdc iam describe-users --output json` (wrong position)
...
- **Skill**: jdcloud-iam-ops
- **Command**: `jdc iam delete-user --user-name <name>` (when user has attached policies)
- **Error**: `ResourceInUse`
...
- **Skill**: jdcloud-iam-ops
- **Command**: `jdc iam describe-users --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-iam-ops` |
