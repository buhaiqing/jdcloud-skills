# Failure Patterns — jdcloud-postgresql-ops
...
- **Command**: `jdc postgresql describe-instance --instance-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (rds-xxxxxxxx)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-postgresql-ops
- **Command**: `jdc postgresql describe-instances` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-postgresql-ops
- **Command**: `jdc postgresql describe-instances --output json` (wrong position)
...
- **Skill**: jdcloud-postgresql-ops
- **Command**: `jdc postgresql delete-instance --instance-id <id>` (when instance is in use)
- **Error**: `ResourceInUse`
...
- **Category**: skill_generation
- **Skill**: jdcloud-postgresql-ops
- **Command**: `jdc postgresql create-instance`
...
- **Skill**: jdcloud-postgresql-ops
- **Command**: `jdc postgresql describe-instances --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-postgresql-ops` |
