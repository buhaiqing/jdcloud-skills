# Failure Patterns — jdcloud-vm-ops
...
- **Command**: `jdc vm describe-instance --instance-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (i-xxxxxxxx)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-vm-ops
- **Command**: `jdc vm describe-instances` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-vm-ops
- **Command**: `jdc vm describe-instances --output json` (wrong position)
...
- **Skill**: jdcloud-vm-ops
- **Command**: `jdc vm delete-instance --instance-id <id>` (when instance is running)
- **Error**: `ResourceInUse`
...
- **Skill**: jdcloud-vm-ops
- **Command**: `jdc vm describe-instances --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-vm-ops` |
