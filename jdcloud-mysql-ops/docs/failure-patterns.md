# Failure Patterns — jdcloud-mysql-ops
...
- **Command**: `jdc mysql describe-instance --instance-id <invalid>`
...
- **Category**: cli_parameter
- **Skill**: jdcloud-mysql-ops
- **Command**: `jdc mysql describe-instances` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-mysql-ops
- **Command**: `jdc mysql describe-instances --output json` (wrong position)
...
- **Skill**: jdcloud-mysql-ops
- **Command**: `jdc mysql delete-instance --instance-id <id>` (when instance is in use)
- **Error**: `ResourceInUse`
...
- **Category**: skill_generation
- **Skill**: jdcloud-mysql-ops
- **Command**: `jdc mysql create-instance`
...
- **Skill**: jdcloud-mysql-ops
- **Command**: `jdc mysql describe-instances --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-mysql-ops` |
