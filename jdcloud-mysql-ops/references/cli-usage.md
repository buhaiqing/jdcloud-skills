...
| Describe Slow Logs | yes | `jdc rds describe-slow-logs` — Query slow query summaries by time range (MySQL only) |
...
| Describe Slow Logs | `jdc --output json rds describe-slow-logs --region-id cn-north-1 --instance-id rds-xxx --start-time "2026-06-01 00:00:00" --end-time "2026-06-03 23:59:59" --page-number 1 --page-size 50` | Query slow query summaries (MySQL only) |
