# Failure Patterns — jdcloud-aiops-cruise
...
### Pattern: MissingResourceDiscovery
- **Category**: skill_generation
- **Skill**: jdcloud-aiops-cruise
- **Command**: Analyze resources without discovery phase
- **Error**: Empty analysis or missing resources
- **Fix**: Always run resource discovery (Phase 1) before analysis (Phase 2)
- **Count**: 1
- **Reusable**: true
...
- **Skill**: jdcloud-aiops-cruise
- **Command**: Cruise analysis targeting VM
- **Error**: VM not found in specified region
- **Fix**: Verify VM exists via `jdcloud-vm-ops` before cruise analysis
- **Count**: 1
- **Reusable**: true
...
- **Category**: cross_skill
- **Skill**: jdcloud-aiops-cruise
- **Command**: Cruise analysis targeting Redis
- **Error**: Redis cluster not in running state
- **Fix**: Verify Redis status via `jdcloud-redis-ops` before analysis
- **Count**: 1
- **Reusable**: true
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-aiops-cruise` |
