"""
jdcloud-aiops-cruise / analyzers / vm_analyzer.py
=================================================
VM / ECS analyzer.
...
K8S_TAG_KEYS = [
    "kubernetes.jdcloud.com/cluster_id",
    "kubernetes.jdcloud.com/node_group_id",
]
...
class VmAnalyzer(BaseAnalyzer):
    ...
    METRICS = [
        ...
        "vm.disk.dev.io.read", "vm.disk.dev.io.write",
        "vm.disk.dev.used",
        "vm.avg.load5",
        "vm.network.dev.bytes.in", "vm.network.dev.bytes.out",
    ...
    def analyze(self) -> list:
        ...
        for vm in self.resources:
            ...
            for iop_metric, label in [("vm.disk.dev.io.read", "读IOPS"),
    ...
    def _estimate_vcpu(instance_type: str) -> int:
        ...
        mapping = {
            "c.n3.large": 2, "c.n3.xlarge": 4, "c.n3.2xlarge": 8,
            "g.n3.large": 2, "g.n3.2xlarge": 8, "g.n3.4xlarge": 16,
            "m.n2.xlarge": 4,
        }
