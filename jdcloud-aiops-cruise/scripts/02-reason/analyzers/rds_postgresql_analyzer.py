"""
jdcloud-aiops-cruise / analyzers / rds_postgresql_analyzer.py
=============================================================
...
Delegates to jdcloud-postgresql-ops skill for actual DB operations.
"""
...
class RdsPostgresqlAnalyzer(BaseAnalyzer):
    ...
    def query_metrics(self, client, hours: int = 6) -> None:
        ...
        require direct database access via jdcloud-postgresql-ops skill.
        """
        self.metrics = {}
    ...
    def analyze(self) -> list:
        ...
        for instance in self.resources:
            ...
            findings.append({
                ...
                "resource_type": "rds_postgresql",
                "severity": "info",
                "message": "Deep analysis (slow queries, VACUUM, locks) requires jdcloud-postgresql-ops",
                "action": "Delegate to jdcloud-postgresql-ops for pg_stat_statements analysis",
                "ops_skill": "jdcloud-postgresql-ops",
                "requires_confirmation": True,
            })
