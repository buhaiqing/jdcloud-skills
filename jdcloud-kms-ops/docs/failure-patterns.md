# Failure Patterns — jdcloud-kms-ops
...
- **Command**: `jdc kms describe-key --key-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (key UUID)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-kms-ops
- **Command**: `jdc kms describe-keys` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-kms-ops
- **Command**: `jdc kms describe-keys --output json` (wrong position)
...
- **Skill**: jdcloud-kms-ops
- **Command**: `jdc kms delete-key --key-id <id>` (when key is in use)
- **Error**: `ResourceInUse`
...
- **Skill**: jdcloud-kms-ops
- **Command**: `jdc kms describe-keys --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-kms-ops` |
