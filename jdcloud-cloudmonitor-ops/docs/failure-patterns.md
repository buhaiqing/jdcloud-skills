# Failure Patterns — jdcloud-cloudmonitor-ops
...
- **Command**: `jdc cloudmonitor describe-alarm --alarm-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (alarm-xxxxxxxx)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-cloudmonitor-ops
- **Command**: `jdc cloudmonitor describe-alarms` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-cloudmonitor-ops
- **Command**: `jdc cloudmonitor describe-alarms --output json` (wrong position)
...
- **Skill**: jdcloud-cloudmonitor-ops
- **Command**: `jdc cloudmonitor delete-alarm --alarm-id <id>` (when alarm is in use)
- **Error**: `ResourceInUse`
...
- **Category**: skill_generation
- **Skill**: jdcloud-cloudmonitor-ops
- **Command**: `jdc cloudmonitor create-alarm`
...
- **Skill**: jdcloud-cloudmonitor-ops
- **Command**: `jdc cloudmonitor describe-alarms --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-cloudmonitor-ops` |
