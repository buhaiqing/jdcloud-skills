# Failure Patterns — jdcloud-elasticsearch-ops
...
- **Command**: `jdc es describe-instance --instance-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (es-xxxxxxxx)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-elasticsearch-ops
- **Command**: `jdc es describe-instances` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-elasticsearch-ops
- **Command**: `jdc es describe-instances --output json` (wrong position)
...
- **Skill**: jdcloud-elasticsearch-ops
- **Command**: `jdc es delete-instance --instance-id <id>` (when instance is in use)
- **Error**: `ResourceInUse`
...
- **Category**: skill_generation
- **Skill**: jdcloud-elasticsearch-ops
- **Command**: `jdc es create-instance`
...
- **Skill**: jdcloud-elasticsearch-ops
- **Command**: `jdc es describe-instances --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-elasticsearch-ops` |
