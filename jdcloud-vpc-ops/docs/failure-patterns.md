# Failure Patterns — jdcloud-vpc-ops
...
- **Command**: `jdc vpc describe-vpc --vpc-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (vpc-xxxxxxxx)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-vpc-ops
- **Command**: `jdc vpc describe-vpcs` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-vpc-ops
- **Command**: `jdc vpc describe-vpcs --output json` (wrong position)
...
- **Skill**: jdcloud-vpc-ops
- **Command**: `jdc vpc delete-vpc --vpc-id <id>` (when VPC has subnets/resources)
- **Error**: `ResourceInUse`
- **Fix**: Stop/detach dependent resources first before deleting (delete subnets and dependent resources first)
- **Count**: 1
- **Reusable**: true
...
- **Skill**: jdcloud-vpc-ops
- **Command**: `jdc vpc describe-vpcs --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-vpc-ops` |
