# Failure Patterns — jdcloud-audit-ops
...
- **Command**: `jdc audit describe-trail --trail-name <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (trail name must match allowed pattern)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-audit-ops
- **Command**: `jdc audit describe-trails` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-audit-ops
- **Command**: `jdc audit describe-trails --output json` (wrong position)
...
- **Skill**: jdcloud-audit-ops
- **Command**: `jdc audit delete-trail --trail-name <name>` (when trail is in use)
- **Error**: `ResourceInUse`
...
- **Category**: skill_generation
- **Skill**: jdcloud-audit-ops
- **Command**: `jdc audit create-trail`
...
- **Skill**: jdcloud-audit-ops
- **Command**: `jdc audit describe-events --page-size 100`
- **Warning**: Response too large, consumes excessive tokens
- **Fix**: Use smaller --page-size or add filters to narrow results (narrow time window)
- **Count**: 1
- **Reusable**: true
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-audit-ops` |
