# Failure Patterns — jdcloud-kubernetes-ops
...
- **Command**: `jdc kubernetes describe-cluster --cluster-id <invalid>`
- **Error**: `InvalidParameter: InvalidResourceId`
- **Fix**: Resource ID must be in valid format (k8s-xxxxxxxx or cluster UUID)
- **Count**: 1
- **Reusable**: true
...
- **Category**: cli_parameter
- **Skill**: jdcloud-kubernetes-ops
- **Command**: `jdc kubernetes describe-clusters` (missing --region-id)
...
- **Category**: cli_parameter
- **Skill**: jdcloud-kubernetes-ops
- **Command**: `jdc kubernetes describe-clusters --output json` (wrong position)
...
- **Skill**: jdcloud-kubernetes-ops
- **Command**: `jdc kubernetes delete-cluster --cluster-id <id>` (when cluster has running node groups)
- **Error**: `ResourceInUse`
- **Fix**: Stop/detach dependent resources first before deleting (delete node groups first)
- **Count**: 1
- **Reusable**: true
...
- **Category**: skill_generation
- **Skill**: jdcloud-kubernetes-ops
- **Command**: `jdc kubernetes create-cluster`
...
- **Skill**: jdcloud-kubernetes-ops
- **Command**: `jdc kubernetes describe-clusters --page-size 100`
...
| Version | Date | Change |
|---------|------|--------|
| 1.0.0 | 2026-06-19 | Initial failure patterns for `jdcloud-kubernetes-ops` |
